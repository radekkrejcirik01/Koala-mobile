...
export const PrivacyPolicyScreen = (): JSX.Element => (
  <ScrollView contentContainerStyle={PrivacyPolicyScreenStyle.contentContainer}>
    <Text style={PrivacyPolicyScreenStyle.title}>Koala App Privacy Policy</Text>
    <Text style={PrivacyPolicyScreenStyle.description}>
      ...
      personalizing your experience, troubleshooting issues, and optimizing the
      App's features and services. 2.2 Communication We may use your contact
      information to respond to your inquiries, provide customer support, and
      send you important updates or notifications related to the App. 2.3
      Aggregated Data We may aggregate and anonymize the information collected
      through the App to generate statistical and analytical insights. This
      aggregated data does not personally identify you and may be used for
      various purposes, including research, marketing, and improving our
      services. Disclosure of Information 3.1 Service Providers We may share
      your information with third-party service providers who assist us in
      operating the App, performing functions on our behalf, or analyzing how
      the App is used. These service providers have access to your information
      only to perform these tasks on our behalf and are obligated not to
      disclose or use it for any other purpose. 3.2 Legal Requirements We may
      ...
      We may also disclose your information to enforce our rights, protect the
      security of the App, or investigate and prevent fraudulent or illegal
      activities. 3.3 Business Transfers If we are involved in a merger,
      ...
      email and/or a prominent notice in the App of any change in ownership or
      uses of your information. Data Security We implement reasonable security
      ...
      guarantee absolute security. Children's Privacy The App is not intended
      for use by individuals under the age of 18. We do not knowingly collect
      personal information from children. If you believe we may have collected
      information from a child without parental consent, please contact us, and
      we will promptly remove the information from our records. Changes to This
      Privacy Policy We reserve the right to modify this Privacy Policy at any
      time. Any changes will be effective immediately upon posting the revised
      Privacy Policy in the App. We encourage you to review this Privacy Policy
      ...
      privacy practices, please contact us at radek.krejcirik01@gmail.com
    </Text>
  </ScrollView>
);
